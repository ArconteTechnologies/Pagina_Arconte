                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                    <h2 class="title">Diseño Digital</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="posts-block col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <h2>Creación visual de alto impacto.</h2>
                                <p>
                                    Ofrecemos el servicio de creación visual de alto impacto (front-end) para los múltiples 
                                    canales y dispositivos de su entorno empresarial, utilizando las mejores prácticas de UX 
                                    (User Experience), además de la creación de contenido multimedia como: videos, animaciones 
                                    y modelado 3D.                    
                                </p>
                            </div>
                            <div class="posts-block col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="item active">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 item wow fadeIn">
                                                    <div class="item-inner"><img alt="" src="img/services/diseño_digital.jpg" width="550" height="400"></div>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 item">
                                                    <div class="item-inner"><img alt="" src="img/services/diseño_digital2.jpg" width="550" height="400"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row padding-top40">
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fas fa-hourglass-half"></i></div>
                                    ...
                                    <div class="content-box-info">
                                        <h3>Metodologías de desarrollo agiles garantizando la mejor calidad en el menor tiempo posible.</h3>
                                        <p>
                                        </p>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="far fa-handshake"></i></div>
                                            <div class="ch-info-back">
                                    ...
                                    <div class="content-box-info">
                                        <h3>Soluciones digitales a la medida de cada cliente.<br><br><br></h3>
                                        <p>
                                        </p>
                                    </div>
                                    <div class="border-bottom margin-top30">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fab fa-mixcloud"></i></div>
                                            <div class="ch-info-back">
                                    ...
                                    <div class="content-box-info">
                                        <h3>Invocación constante en cada producto y en cada servicio para su empresa.</h3>
                                        <p>
                                        </p>
                                    </div>
                                    <div class="border-bottom margin-top30">
