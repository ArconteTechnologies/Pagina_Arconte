...
/*----------------------------------------------------*/
	...
	jQuery('#maps').gMap({
		...
		markers: [{
			latitude: 20.587929,
			longitude: -100.387947,
			html: "<h4>Arconte Technologies</h4>Santiago de Querétaro, Qro.",
			popup: true
		}]
	});
...
$("#contact").submit(function (e) {
    ...
    var text = $("#text").val();
    var dataString = 'name=' + name + '&email=' + email + '&telephone=' + telephone + '&subject=' + subject + '&text=' + text;
