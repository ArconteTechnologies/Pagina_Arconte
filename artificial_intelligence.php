                    ...
                    <div class="container">
                        <div class="row">
                            <div class="posts-block col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <h2>El intrigante cambio hacia el futuro.</h2>
                                <p>
                                    El intrigante cambio hacia el futuro obliga a las PyMEs a tomar decisiones 
                                    cruciales para su crecimiento, sin duda las nuevas tecnologías juegan un papel 
                                    muy importante a la hora de medir si estas decisiones fueron acertadas o 
                                    totalmente un fracaso.                     
                                </p>
                                <p>
                                    Por esta razón te ayudamos a desarrollar las aplicaciones del futuro con inteligencia 
                                    artificial, utilizando técnicas de última generación para el crecimiento de su empresa, 
                                    así como la asesoría en este tema para que no pierda el rumbo del futuro tecnológico.                     
                                </p>
                            </div>
                            <div class="posts-block col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="item active">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 item wow fadeIn">
                                                    <div class="item-inner"><img alt="" src="img/services/inteligencia_artificial.png" width="550" height="400"></div>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 item">
                                                    <div class="item-inner"><img alt="" src="img/services/inteligencia_artificial2.jpg" width="550" height="400"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row padding-top40">
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fa fa-database"></i></div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="content-box big ch-item bottom-pad-small">
                                    ...
                                    <div class="content-box-info">
                                        <h3>Machine learning<br><br><br></h3>
                                        <p>
                                        </p>
                                    </div>
                                    <div class="border-bottom margin-top30">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fas fa-chart-bar"></i></div>
                                            <div class="ch-info-back">
                                    ...
                                    <div class="content-box-info">
                                        <h3>Impulsando su negocio con asesoría especializada en IA</h3>
                                        <p>
                                        </p>
                                    </div>
                                    <div class="border-bottom margin-top30">
