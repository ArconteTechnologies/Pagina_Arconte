...
<html> 
    ...
    <head>
        <meta charset="utf-8">
        <title>ARCONTE TECHNOLOGIES</title>
        ...
        <div class="wrap">
            ...
            <section id="main">
                ...
                <div class="fullwidthbanner-container tp-banner-container">
                    <div class="fullwidthbanner rslider tp-banner">
                        <ul>
                            ...
                            <li data-transition="fade" data-masterspeed="1000" data-delay="5000">
                                <img src="img/inteligencia_artificial.jpg" alt="">
                                </video>                                
                                <div class="caption large_text sft"
                                    ...
                                    data-speed="300"
                                    data-start="800"
                                    data-easing="easeOutExpo"  >Inteligencia</div>
                                <div class="caption large_text sfr"
                                    data-x="240"
                                    data-y="100"
                                    data-speed="300"
                                    data-start="1100"
                                    data-easing="easeOutExpo"><span class="dblue">Artificial</span></div>
                                ...
                                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                                    ...
                                    data-endspeed="300"
                                    style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">Un nuevo mundo
                                </div>
                                ...
                                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                                    ...
                                    data-endelementdelay="0.1"
                                    data-endspeed="300"
                                    style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">El futuro te espera
                                </div>
                                <div class="tp-caption greenbox30 customin fadeout tp-resizeme rs-parallaxlevel-10"
                                    data-x="730"
                                    data-y="270" 
                                ...
                                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                                    ...
                                    data-endelementdelay="0.1"
                                    data-endspeed="300"
                                    style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">Arconte es tu transporte
                                </div>
                                <div class="tp-caption greenbox30 customin fadeout tp-resizeme rs-parallaxlevel-10"
                                    data-x="700"
                                    data-y="320" 
                            ...
                            <!-- internet de als cosas -->
                            <li data-transition="fade" data-masterspeed="3000" data-delay="5000">
                                <img src="img/internet_de_las_cosas.jpg" alt="">
                                </video>                                
                                <div class="caption large_text sft"
                                    data-x="80"
                                    data-y="54"
                                    data-speed="300"
                                    data-start="800"
                                    data-easing="easeOutExpo"  >Internet</div>
                                <div class="caption large_text sfr"
                                    data-x="80"
                                    data-y="100"
                                    data-speed="300"
                                    data-start="1100"
                                    data-easing="easeOutExpo"><span class="dblue">de las cosas</span></div>
                                ...
                                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                                    ...
                                    data-endelementdelay="0.1"
                                    data-endspeed="300"
                                    style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">Por un mundo conectado
                                </div>
                                <div class="tp-caption greenbox30 customin fadeout tp-resizeme rs-parallaxlevel-10"
                                    data-x="760"
                                    data-y="220" 
                                ...
                                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                                    ...
                                    data-endelementdelay="0.1"
                                    data-endspeed="300"
                                    style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">Mejora tu estilo de vida
                                </div>
                                <div class="tp-caption greenbox30 customin fadeout tp-resizeme rs-parallaxlevel-10"
                                    data-x="730"
                                    data-y="270" 
                                ...
                                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                                    ...
                                    data-endelementdelay="0.1"
                                    data-endspeed="300"
                                    style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">Industria 4.0
                                </div>
                                <div class="tp-caption greenbox30 customin fadeout tp-resizeme rs-parallaxlevel-10"
                                    data-x="700"
                                    data-y="320" 
                            ...
                            <!-- internet de als cosas -->
                            <li data-transition="fade" data-masterspeed="3000" data-delay="5000">
                                <img src="img/digital_design.jpg" alt="">
                                </video>                                
                                <div class="caption large_text sft"
                                    data-x="80"
                                    data-y="54"
                                    data-speed="300"
                                    data-start="800"
                                    data-easing="easeOutExpo"  >Digital</div>
                                <div class="caption large_text sfr"
                                    data-x="150"
                                    data-y="100"
                                    data-speed="300"
                                    data-start="1100"
                                    data-easing="easeOutExpo"><span class="dblue">Design</span></div>
                                ...
                                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                                    ...
                                    data-endelementdelay="0.1"
                                    data-endspeed="300"
                                    style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">Hacemos realidad tus ideas
                                </div>
                                <div class="tp-caption greenbox30 customin fadeout tp-resizeme rs-parallaxlevel-10"
                                    data-x="760"
                                    data-y="220" 
                                ...
                                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                                    ...
                                    data-endelementdelay="0.1"
                                    data-endspeed="300"
                                    style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">En arconte no existen los límites
                                </div>
                                <div class="tp-caption greenbox30 customin fadeout tp-resizeme rs-parallaxlevel-10"
                                    data-x="730"
                                    data-y="270" 
                                ...
                                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                                    ...
                                    data-endelementdelay="0.1"
                                    data-endspeed="300"
                                    style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">Tu pones la idea, nosotros el código
                                </div>
                                <div class="tp-caption greenbox30 customin fadeout tp-resizeme rs-parallaxlevel-10"
                                    data-x="700"
                                    data-y="320" 
                ...
                <div class="main-content">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 wow fadeIn">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fa fa-brain"></i></div>
                                    ...
                                    <div class="content-box-info">
                                        <h3>Inteligencia</h3>
                                        <p>
                                            Inteligencia es la palabra clave para el éxito, por esta razón Arconte pone a su disposición servicios de Inteligencia Artificial.
                                        </p>
                                        <a href="artificial_intelligence.php">Leer Más <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 wow fadeIn">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fas fa-globe-americas"></i></div>
                                            <div class="ch-info-back">
                                    ...
                                    <div class="content-box-info">
                                        <h3>Digital</h3>
                                        <p>
                                            ¡Bienvenido al mundo disruptivo! conozca los servicios Arconte que llevarán a su empresa a la transformación digital.
                                        </p>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 wow fadeIn">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fas fa-mobile-alt"></i></div>
                                            <div class="ch-info-back">
                                    ...
                                    <div class="content-box-info">
                                        ...
                                        <p>
                                            Ofrecemos un desarrollo superior de Aplicaciones móviles para su negocio, minimizando riesgos y aumentando la efectividad.
                                        </p>
                                        <a href="#">Leer Más <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
                                    </div>
                                    <div class="border-bottom margin-top30">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 wow fadeIn">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fa fa-charging-station"></i></div>
                                            <div class="ch-info-back">
                                    ...
                                    <div class="content-box-info">
                                        <h3>IoT</h3>
                                        <p>
                                            El internet de las cosas puede hacer mucho por usted. No pierda la oportunidad de trabajar con Arconte creando el futuro.
                                        </p>
                                        <a href="#">Leer Más <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
                                    </div>
                                    <div class="border-bottom margin-top30">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-xs-12 text-center wow fadeInLeft">
                                    <img class="app-img" src="img/tecnologia-futuro.png">
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12 wow fadeInRight">
                                    <div class="app-service padding-bottom50">
                                        <h2 class="light">Tecnología Inteligente Para Tu Empresa Inteligente</h2>
                                        <h4>Mediante la Inteligencia Artificial y nuestros servicios de vanguardia llevamos a tu empresa a la transformación digital, un paso más hacia el exito empresarial.</h4>
                                        </p>
                                        <div class="divider"></div>
                                        <div class="learnmore">
                                            <a class="btn-special btn-grey" href="artificial_intelligence.php">Leer Más</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="padding-top40 text-center">
                                        <h2 class="light wow fadeIn">Paquete Arconte Premium</h2>
                                        <h3 class="light wow fadeInRight">
                                            ¿Buscas darle un plus a tu negocio?
                                        </h3>
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <h4 class="light wow fadeInRight">
                                                    El Paquete Arconte Premium es la mejor opción ya que te ofrecemos el diseño de tu landing Page, diseñamos tu publicidad y ponemos tu sitio en línea en nuestros servidores por un precio que se ajusta a tus bolcillos.
                                                </h4>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 text-center wow fadeInLeft">
                                    <div class="service-box padding-top30 padding-bottom40">
                                        <div class="service-box-icon">
                                            <a href="#"><img alt="Web Design" src="img/icons/diseño-web.png" width="220" height="120"></a>
                                        </div>
                                        <div class="service-box-info">
                                            <a href="#">
                                                <h3 class="padding-top25">Landing Page</h3>
                                            </a>
                                            <p>
                                                Te realizamos el diseño de tu sitio web informativo para tu negocio y/o PyMe.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 text-center wow fadeInUp">
                                    <div class="service-box padding-top30 padding-bottom40">
                                        <div class="service-box-icon">
                                            <a href="#"><img alt="Email Marketing" src="img/icons/publicidad.png" width="150" height="120"></a>
                                        </div>
                                        <div class="service-box-info">
                                            <a href="#">
                                                <h3 class="padding-top25">Publicidad</h3>
                                            </a>
                                            <p>
                                               Diseñamos la publicidad necesaria para tu negocio.   
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 text-center wow fadeInRight">
                                    <div class="service-box padding-top30 padding-bottom40">
                                        <div class="service-box-icon">
                                            <a href="#"><img alt="Corportate Solutions" src="img/icons/hosting.png" width="150" height="120"></a>
                                        </div>
                                        <div class="service-box-info">
                                            <a href="#">
                                                <h3 class="padding-top25">Hosting</h3>
                                            </a>
                                            <p>
                                               Colocamos tu sitio web en linea.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="text-center">
                                        <h2 class="light wow fadeIn">¡Si el paquete no es el que buscaba, nos adaptamos a sus necesidades!</h2>
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <h5 class="light wow fadeInRight">
                                                    Contáctenos para conocer más acerca de nuestros paquetes
                                                </h5>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                ...
                <div id="testimonials" class="padding-top100">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="text-center">
                                    <h2 class="wow fadeIn">No lo decimos nosotros, lo dicen nuestros clientes</h2>
                                    <h4 class="wow fadeInRight">Nuestro nivel de soporte es de excelencia ya que respondemos al instante y las soluciones son confiables</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                                ...
                                                <div class="item active">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="testimonial item">
                                                            <p>
                                                                Recomiendo al 100% a la empresa ARCONTE TECHNOLOGIES, estoy muy satisfecho con el sitio web que crearon para mi grupo de investigación paranormal INFRAMUNDO SMA; son muy profesionales, responsables y puntuales con la entrega.<br>Atte. Eduardo Cummings fundador de INFRAMUNDO SMA.
                                                            </p>
                                                            ...
                                                            <div class="author">
                                                                ...
                                                                <div class="testimonial-author-info">
                                                                    <span class="color">Eduardo Cummings</span><br><span style="color:black">Inframundo SMA<span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="padding-top60 text-center">
                                        <h4 class="light wow fadeInRight">
                                            EXCEDIENDO LOS LÍMITES A CADA MINUTO
                                        </h4>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn">
                                    <div class="random-box padding-top30 padding-bottom40">
                                        ...
                                        <div class="random-box-info">
                                            <span class="facts" data-from="0" data-to="2018" data-speed="5000" data-refresh-interval="50"></span>
                                            <p>
                                                TAZAS DE CAFÉ
                                            </p>
                                        </div>
