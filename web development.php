                    ...
                    <div class="container">
                        <div class="row">
                            <div class="posts-block col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <h2>Desarrollo eficiente, personalizado, ágil y de la más alta calidad.</h2>
                                <p>
                                    Hoy en día la era digital es un hecho, se ha convertido en una obligación mercadológica 
                                    para las empresas estar en internet, Arconte le ofrece un posicionamiento claro y firme 
                                    en la red de redes(internet) con el desarrollo de páginas web, así como de sistemas en 
                                    la nube con un desarrollo eficiente, personalizado, ágil y de la más alta calidad.                    
                                </p>
                            </div>
                            <div class="posts-block col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="item active">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 item wow fadeIn">
                                                    <div class="item-inner"><img alt="" src="img/services/diseño_web.jpg" width="550" height="400"></div>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 item">
                                                    <div class="item-inner"><img alt="" src="img/services/diseño_web2.jpg" width="550" height="400"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row padding-top40">
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fas fa-cubes"></i></div>
                                    ...
                                    <div class="content-box-info">
                                        <h3>Integración de servicios.<br><br></h3>
                                        <p>
                                        </p>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fas fa-code"></i></div>
                                            <div class="ch-info-back">
                                    ...
                                    <div class="content-box-info">
                                        <h3>Desarrollo personalizado siguiendo la esencia de su empresa.<br><br></h3>
                                        <p>
                                        </p>
                                    </div>
                                    <div class="border-bottom margin-top30">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="content-box big ch-item bottom-pad-small">
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            <div class="ch-info-front ch-img-1"><i class="fas fa-flag-checkered"></i></div>
                                            <div class="ch-info-back">
                                    ...
                                    <div class="content-box-info">
                                        <h3>Análisis orientado a servicios para garantizar el éxito empresarial.</h3>
                                        <p>
                                        </p>
                                    </div>
                                    <div class="border-bottom margin-top30">
